...
if (target === "production" || target === "prod") {
  console.log(
    [
      ...
      "  - Optional repo Variable RADARTIPS_PAGES_PROJECT_NAME if workflow project input is empty",
      "",
      "- Local: npm run build && npm run pages:deploy (Cloudflare keys in .env.production.local)",
      "",
